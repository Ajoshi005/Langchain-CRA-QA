...
st.sidebar.markdown(f"[View My Resume on LinkedIn]({linkedin_url})")
...
st.sidebar.write(
    "This is a personal tax assistant app that provides answers to queries related to personal tax filing for the year 2022-23. "
    "The answers are generated by an AI model and may not be entirely accurate or up-to-date. For personalized and accurate tax-related advice, "
    "it is recommended to consult a certified tax professional from the Canada Revenue Agency (CRA) or other qualified experts."
)
